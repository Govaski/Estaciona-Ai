...
//                        .requestMatchers("/api/reservas/request").hasRole("DRIVER")
//                        .requestMatchers("/api/reservas/{id}/accept").hasRole("PARK")
//                        .requestMatchers("/api/reservas/{id}/conclude").hasRole("PARK")
//                        .anyRequest().authenticated()
                                .anyRequest().permitAll() // apenas para fins demonstrativos, remover no produto final!
                )
